" Configurações simples para rodar em qualquer computador
" Se não estivr usando vim puro, delete esse arquivo e prefira init.lua
...
:set tabstop=2             " <Tab> faz 4 espaços
:set shiftwidth=2          " <Shift> faz 4 espaços
:set smarttab              " <Tab> no final de uma linha
:set softtabstop=2         " Faz alguma coisa aí
